...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="DonarListForAdmin" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="UserId" DataSourceID="DonarList" ForeColor="#333333" GridLines="None">
